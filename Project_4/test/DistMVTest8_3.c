...
int main()
{
	...
	for (loop =0; loop<500; loop++) 
	{
		...
		Print("Client 3: Trying for access to MV..\n",-1,-1,-1);
		...
		mvEdit = GetMV("mv");
		Print("Client 3: Monitor variable was read to be %d..",mvEdit,-1,-1);
		...
		Print("Client 3: Monitor variable was set to be %d..",mvEdit,-1,-1);
		
		ReleaseLock("lock1");	

		Print("\n\n\n\nClient 3: %d Iterations done..",(loop+1),-1,-1);
	}
