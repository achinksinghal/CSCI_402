...
typedef struct _Manager
{
	...
	int state;/*state of manager*/
	int msgToAll;/*transmit message to all entitites*/
...
typedef struct _Cust
{
	...
	int location;/*current location of customer*/
	int state;/*state of cutomer*/
...
{/*ticket clerk*/
	...
	int msgByMan;/*message from Manager*/
	int msgFromCust;/*message from customer*/
	int location;/*place where he is*/
	int state;/*state he is in*/
}TC;
...
{/*ticket taker*/
	...
	Manager *man;/*a thread to manager*/
        /*Thread *selfThread;// a thread to self*/
	int msgByMan;/*message from Manager*/
	int msgToMan;/* send message to manager*/
	int msgToCust;/*notify customer*/
	int msgFromCust;/*interact with customer*/
	int queueType;/*type of queue for clerk*/
	mtQueue *queue;/*the actual queue*/
	int location;/*place where he is*/
	int state;/*state he is in*/
