...
int Machine :: ResizePageTable()
{
	...
	pageTable = new TranslationEntry[pageTableSize + numberOfStackPages];
	
	for(int idx = 0; idx < (int)pageTableSize; idx++)
	{
	...
	{	
		pgIdx = pageTableSize + Idx;
		
		pageTable[pgIdx].virtualPage = pageTableSize + pgIdx;	
	...
	pageTableSize += numberOfStackPages;
